      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              {images.map((img, index) => (
                <button
                  ...
                  className={`relative aspect-square ${
                    selectedImage === index ? "ring-2 ring-purple-500 rounded-md" : ""
                  }`}
                >
                  <Image
                    src={img}
          ...
          <div className="space-y-6 bg-zinc-800 p-6 rounded-lg h-full">
            <h1 className="text-3xl font-bold text-purple-400">Fanta light</h1>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedPlan(
                    plans.find((plan) => plan.id === e.target.value) || plans[0]
                  )
                }
              >
                {plans.map((plan) => (
            ...
            <button
              className="w-full bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md transition-colors flex items-center justify-center"
            ...
            <p className="text-gray-300">
              O Fanta light é a solução definitiva para elevar seu jogo ao
              próximo nível. Com tecnologia de ponta e atualizações constantes,
              garantimos que você sempre esteja um passo à frente da
              concorrência.
            </p>
          </div>
        </div>
