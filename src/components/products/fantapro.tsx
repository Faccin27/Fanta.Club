      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6 bg-zinc-800 p-6 rounded-lg h-full">
            ...
            <button
              className={`w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-md transition-colors flex items-center justify-center disabled:opacity-50 ${
            ...
            <p className="text-gray-300">{t("translation.pro_fanta")}</p>
          </div>
        </div>

        <div className="mt-16 bg-zinc-800 rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">
            {t("translation.pro_fanta_features")}
          </h2>
