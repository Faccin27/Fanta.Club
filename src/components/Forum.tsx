...
import { Bell, HelpCircle, RefreshCw, Search, Settings } from "lucide-react";
...
const ForumPage: React.FC = () => {
  ...
  const categories: ForumCategory[] = [
    {
      icon: Bell,
      label: t("translation.Announcements"),
      color: "text-yellow-500",
    },
    {
      icon: RefreshCw,
      label: t("translation.Updates"),
      color: "text-blue-500",
    },
    {
      icon: Settings,
      label: t("translation.Configs"),
      color: "text-green-500",
    },
    {
      icon: HelpCircle,
      label: t("translation.Questions"),
